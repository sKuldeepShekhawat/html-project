...
?>
<html>
<head><title>Review Please....</title>
<style>
body{
...
<span class=proimg>
<div class=back></div>
<img src="images/<?php echo $_SESSION["img1"]; ?>" alt="<?php echo $_SESSION["name"]; ?>" height=100px  style="z-index:50;transform:translate(-50%);position:absolute;left:50%">
</span>
...
<a href="chpass.php"><button name=chpasss class=probut>Change Password</button></a>
</form>
<div class="sec_id">
<form method=post>
